...
with my_app.app_context():
    ...
    db.session.add(Person(name="Madina Dzhetegenova", dob="1985-09-05", father_id=2, mother_id=1,place_of_birth=None))
    db.session.add(Person(name="Assel Jetegenova", dob="1983-03-15", father_id=2, mother_id=1,place_of_birth=None))
    db.session.add(Person(name="Keira Doroshenko", dob="2010-09-29", father_id=6, mother_id=3,place_of_birth=None))
    db.session.add(Person(name="Sergey Doroshenko", dob="1983-07-07", father_id=None, mother_id=None,place_of_birth=None))
    db.session.add(Person(name="Alan Doroshenko", dob="2012-11-27", father_id=6, mother_id=3,place_of_birth=None))
    db.session.add(Person(name="Marina Doroshenko", dob="2017-11-30", father_id=6, mother_id=3,place_of_birth=None))
